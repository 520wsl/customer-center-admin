        ...
        <Card class="md-card">
            <div class="search-con search-con-top flex">
                <div class="search-input-item">
                    <Select class="search-col" v-model="params.evaluateType" @on-change='evaluateTypeChange'
                            palceholder="评价维度">
                        <Option v-for="(item,index) in evaluateTypeList" :key='index' :value="item.key">{{item.value}}
                        </Option>
                    </Select>
                    <Input class="search-input" v-model="params.value" :disabled="evaluateNameBool"
                ...
                <div class="search-input-item">
                    <Select class="search-col" v-model="params.customerInfo" palceholder="工单编号">
                        <Option v-for="(item,index) in workorderTypeList" :key='index' :value="item.key">
                            {{item.value}}
                        </Option>
                    </Select>
                ...
                <div class="search-input-item">
                    <Select class="search-col" v-model="params.workType" palceholder="工单类型">
                        ...
                        <Option v-for="(item,index) in searchWorkSheetType" :key='index' :value="item.key">
                            {{item.value}}
                        </Option>
                    </Select>
                </div>
                <div class="search-input-item">
                    <span>评价时间：</span>
                    <div class="search-input-item">
                        <DatePicker class="search-input" v-model="params.timeMin" format="yyyy-MM-dd"
                                    type="date"></DatePicker>
                        <DatePicker class="search-input" v-model="params.timeMax" format="yyyy-MM-dd"
                                    type="date"></DatePicker>
                    </div>
                </div>
                <div class="search-input-item">
                    <span>执行人：</span>
                    <Department class="search-input-item" :loading-user="true" width="200" :get-user-info="getUserInfo"
